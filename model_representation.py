...
def get_flow_size_and_class_pkt():
    ...
    with open(current_path+'/switch/control_plane/flow_size_and_class_pkt.pkl','wb') as f:
...
def get_class_flow():
    ...
    with open(current_path+'/switch/control_plane/bin_table_and_class_flow.pkl','wb') as f:
